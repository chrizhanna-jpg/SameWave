...
export const CURATED_BY_UNSPLASH_ID = {
  ...
  "1557495235-340eb888a9fb": {
    tags: ["dog","pets","animal","people","friends","outdoors"],
  ...
  "1558385952-504347abdceb": {
    tags: ["dog","pets","animal","people","outdoors","park"],
...
/**
 * @param {{ unsplashId: string, theme: string, tags: string[], subjects: string[], shapes?: string[], bucket: string }} row
 */
export function applyCuratedLabels(row) {
  const c = CURATED_BY_UNSPLASH_ID[row.unsplashId];
  if (!c) return row;
  return {
    ...row,
    tags: c.tags,
    subjects: c.subjects,
    shapes: c.shapes ?? row.shapes ?? [],
  };
}
